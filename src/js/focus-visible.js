...
function applyFocusVisiblePolyfill(scope) {
    ...
    function addFocusVisibleClass(el) {
        if (el.classList.contains(FOCUS_CLASSNAME)) {
            return;
        }
        el.classList.add(FOCUS_CLASSNAME);
    ...
    function removeFocusVisibleClass(el) {
        ...
        el.classList.remove(FOCUS_CLASSNAME);
    ...
    function onBlur(e) {
        ...
        if (
            e.target.classList.contains(FOCUS_CLASSNAME) ||
